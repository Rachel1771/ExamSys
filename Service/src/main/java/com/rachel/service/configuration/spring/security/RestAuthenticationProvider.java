package com.rachel.service.configuration.spring.security;


import com.rachel.service.context.WebContext;
import com.rachel.service.domain.enums.RoleEnum;
import com.rachel.service.domain.enums.UserStatusEnum;
import com.rachel.service.service.AuthenticationService;
...
public class RestAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        com.rachel.service.domain.User user = userService.getUserByUserName(username);
        if (user == null) {
